package cn.harveychan.kaimaa.web.admin;
...
public class TypeController {
    ...
    public String postPost(@Valid Type type, BindingResult result, @PathVariable Long id, RedirectAttributes attributes) {
        if (typeService.getTypeByName(type.getName()) != null) {
            result.rejectValue("name", "nameError", "不能添加重复的分类");
        }
        if (result.hasErrors()) {
        ...
        type = typeService.updateType(id, type);
        if (type == null) {
